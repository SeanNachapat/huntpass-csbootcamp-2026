...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-zoo-blue-50 to-slate-100 text-slate-800 relative overflow-hidden">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 z-10">
        <div className="text-center mb-10">
          <div className="inline-block bg-white p-4 rounded-full shadow-lg text-zoo-amber-500 mb-6 border border-slate-100">
            <PawPrint size={48} className="drop-shadow-sm" />
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-zpd-navy to-zoo-blue-600 tracking-tight mb-3">
            HuntPass
          </h1>
        ...
        <div className="w-full max-w-sm bg-white shadow-2xl rounded-[2rem] p-8 border border-white/50 backdrop-blur-sm">
          <h2 className="text-xl font-bold text-zpd-navy mb-6 text-center">เข้าสู่ระบบ</h2>
